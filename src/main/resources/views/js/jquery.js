    ...
    jQuery.extend({
        valHooks: {
            option: {
                ...
                get: function (elem) {
                    var value, i, max, option, index = elem.selectedIndex, values = [], options = elem.options,
 ...
 */
    ...
    var curCSS, iframe, iframeDoc, ralpha = /alpha\([^)]*\)/i, ropacity = /opacity=([^)]*)/,
        ...
        rrelNum = new RegExp("^([-+])=(" + core_pnum + ")", "i"), elemdisplay = {},
        ...
        var result, index = 0, tweenerIndex = 0, length = animationPrefilters.length,
            deferred = jQuery.Deferred().always(function () {
                ...
                var currentTime = fxNow || createFxNow(),
                    ...
                    percent = 1 - (remaining / animation.duration || 0), index = 0, length = animation.tweens.length;
                for (; index < length; index++) {
    ...
    function defaultPrefilter(elem, props, opts) {
        var index, prop, value, length, dataShow, tween, hooks, oldfire, anim = this, style = elem.style, orig = {},
...
var jQuery = $.extend($, {
    // 提示框
    alert: function (content, time, fn) {
        var wrap = document.createElement("div");
        var L = content.length;
        wrap.innerHTML = content;
        document.body.appendChild(wrap);
        wrap.style.cssText = "position:fixed;bottom:50%;left:50%;margin-left:-50px;margin-top:-25px;" +
            "text-align:center;line-height:50px;background-color:rgba(0, 0, 0, 0.86);;z-index:2;font-size:16px;" +
            "border-radius:5px;color:#fff;height:50px;min-width:100px";
        if (L > 5) {
