...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/widgets/daterangepicker/daterangepicker.css" />
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/assets/widgets/daterangepicker/moment.js"></script>	
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/assets/widgets/daterangepicker/daterangepicker.js"></script>
<style>
.fgf{color: #ddd;}
.opt a{display: inline-block;padding: 0 5px;}
.opt .links{margin-top: 3px;}
.un-sekill-ac-body-td a{text-decoration: none;}
   .dropdown-menu.inner
